...
#define mqtt_topic_pub "server_room/mlx96014/pub"
#define mqtt_topic_sub "server_room/mlx96014/sub"
...
//  Serial.println(esid.c_str());
//  Serial.println(epass.c_str());
  // Check wifi status, if not connected, then reconnect
...
//    }
    ...
    if (ambient_temp<0 || ambient_temp>100 || object_temp<0 || object_temp>100){
    
    }
    else{
      json_buffer["temperature"] = ambient_temp;
